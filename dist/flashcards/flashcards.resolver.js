...
const create_flashcards_input_1 = require("./dto/create-flashcards.input");
...
let FlashcardsResolver = class FlashcardsResolver {
    ...
    createFlashCards(createFlashcardsInput) {
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, graphql_1.Mutation)(() => [flashcards_entities_1.Flashcards]),
    __param(0, (0, graphql_1.Args)('createFlashCardsInput')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_flashcards_input_1.CreateFlashcardsInput]),
    __metadata("design:returntype", void 0)
], FlashcardsResolver.prototype, "createFlashCards", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
