...
let FlashcardSetsResolver = class FlashcardSetsResolver {
    ...
    createFlashCardSet(flashcardSetsInput, context) {
        ...
        return this.flashcardSetsService.createFlashcardSet(flashcardSetsInput, userId);
    }
    createFlashCardSetWithFlashcards(flashcardSetsInput, context) {
        const userId = context.req.user.id;
        return this.flashcardSetsService.createFlashcardSetWithFlashcards(flashcardSetsInput, userId);
    }
    viewFlashCardSet(flashcardSetsInput, context) {
        const userId = context.req.user.id;
    ...
    deleteFlashcardSets(flashcardSetsInput, context) {
        return this.flashcardSetsService.deleteFlashcardSets(flashcardSetsInput.subject, context.req.user.id);
    }
};
...
__decorate([
    ...
    __param(0, (0, graphql_1.Args)('createFlashCardSetInput')),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, graphql_1.Mutation)(() => flashcard_sets_entity_1.FlashCardSets),
    __param(0, (0, graphql_1.Args)('createFlashCardSetWithFlashcardsInput')),
    __param(1, (0, graphql_1.Context)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [flashcard_sets_input_1.FlashCardSetsInput, Object]),
    __metadata("design:returntype", void 0)
], FlashcardSetsResolver.prototype, "createFlashCardSetWithFlashcards", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, graphql_1.Query)(() => flashcard_sets_entity_1.FlashCardSets, { name: 'flashCardSet' }),
    __param(0, (0, graphql_1.Args)('viewFlashCardSetInput')),
    __param(1, (0, graphql_1.Context)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [flashcard_sets_input_1.FlashCardSetsInput, Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, graphql_1.Mutation)(() => flashcard_sets_entity_1.FlashCardSets),
    __param(0, (0, graphql_1.Args)('updateFlashCardSetInput')),
    __param(1, (0, graphql_1.Context)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [flashcard_sets_input_1.FlashCardSetsInput, Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, graphql_1.Mutation)(() => flashcard_sets_entity_1.FlashCardSets),
    __param(0, (0, graphql_1.Args)('deleteFlashCardSetInput')),
    __param(1, (0, graphql_1.Context)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [flashcard_sets_input_1.FlashCardSetsInput, Object]),
    __metadata("design:returntype", void 0)
