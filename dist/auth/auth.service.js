...
const bcyrpt = __importStar(require("bcrypt"));
let AuthService = class AuthService {
    ...
    async signUp(signUpInput) {
        ...
        if (userExists) {
            throw new common_1.UnauthorizedException('User already exist. Please login instead');
        }
    ...
    async login(email, password) {
        ...
        if (!userExists) {
            throw new common_1.UnauthorizedException('User does not exist. Please signup instead.');
        }
